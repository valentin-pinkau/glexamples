...
# GLEXAMPLES_INCLUDE_DIRS -> <PROJECT_NAME>_INCLUDE_DIRS
...
macro (find LIB_NAME HEADER)
    ...
    list(APPEND GLEXAMPLES_INCLUDE_DIRS ${${LIB_NAME_UPPER}_INCLUDE_DIR})
...
# DEBUG
# message("GLEXAMPLES_INCLUDE_DIRS  = ${GLEXAMPLES_INCLUDE_DIRS}")
# message("GLEXAMPLES_LIBRARIES = ${GLEXAMPLES_LIBRARIES}")

find_package_handle_standard_args(GLEXAMPLES DEFAULT_MSG GLEXAMPLES_LIBRARIES GLEXAMPLES_INCLUDE_DIRS)
